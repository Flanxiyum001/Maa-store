      ...
      <main className="flex-1 py-12 md:py-24">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="bg-background/60 backdrop-blur-sm border border-border/40 rounded-2xl p-8 md:p-12 shadow-lg">
            <h1 className="font-serif text-4xl md:text-5xl font-bold mb-2 text-primary">Return & Refund Policy</h1>
            ...
            <div className="prose prose-invert max-w-none space-y-6 text-foreground">
              ...
              <section>
                <h2 className="text-2xl font-serif font-bold mb-4 text-primary">Cancellation Policy</h2>
                <ul className="space-y-3 ml-6">
                  ...
                  <li className="text-muted-foreground">
                    <strong>Perishable Items:</strong> MAA TRADITIONAL LIFESTYLE STORE does not accept cancellation requests for perishable items. However, refund/replacement can be made if the customer establishes that the quality of product delivered is not good.
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-4">
                  In case of receipt of damaged or defective items please report the same to our Customer Service team via WhatsApp at +91 83400 00987. The request will be entertained once the merchant has checked and determined the same at his own end.
                </p>
                <p className="text-muted-foreground">
                  <strong>Important:</strong> This should be reported within 7 days of receipt of the products.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  <strong>Contact:</strong> All refund requests should be addressed to us via WhatsApp at +91 83400 00987 with a clear description of your complaint or refund reason.
                </p>
              </section>

              <div className="mt-12 pt-8 border-t border-border/40">
                <p className="text-sm text-muted-foreground text-center">
                  For any questions about our Return & Refund Policy, please contact us on WhatsApp: +91 83400 00987
                </p>
              </div>
            </div>
          </div>
